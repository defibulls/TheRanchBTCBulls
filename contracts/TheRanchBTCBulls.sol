...
//     //         _safeMint(_coreTeam_1, _tokenIdCounter.current());
//     //     }
...
//         //if (_tokenIdCounter.current() + _tokenQuantity > maxSupply) {revert Minting_ExceedsTotalBulls();}


//         IERC20Upgradeable mintingToken = IERC20Upgradeable(usdcTokenContract);
...
//         emit NewBullsEnteringRanch(msg.sender,_enterRaffle, _tokenQuantity, _tokenIdCounter.current());
//     }

//     function fundBulls(uint _stockyardNumber, uint256 _totalAmountToDeposit) public payable {
...
//     function rewardBulls(uint _stockyardNumber) public payable  {
...
//     function updateMaintenanceFeesForTheMonth() external  {
...
//     function updateMonthsBehindMaintenanceFeeDueDate() external {
//         // if (!paused) { revert Maintenance_UpdatingNotReady();}
...
//     function getLiquidatedArrayLength() public view  returns (uint) {
//         return upForLiquidation.length;
//     }

//     function liquidateOutstandingAccounts() external  {
//         // if (!paused) { revert Maintenance_UpdatingNotReady();}
...
//     function kickOffDailyRaffle() external  {
//         pause();
...
//     function withdrawBtcMinerBalance() external  {
...
//     function withdrawWarChestBalance() external  {
//         IERC20Upgradeable tokenContract = IERC20Upgradeable(usdcTokenContract);
...
//     //ERC165
//     function supportsInterface(bytes4 interfaceId) public view override( ERC721Upgradeable, ERC721EnumerableUpgradeable, IERC165Upgradeable, AccessControlUpgradeable) returns (bool) {
...
//         if (_endingIndex > _tokenIdCounter.current()) { revert Stockyard_BadInputParameter();}
