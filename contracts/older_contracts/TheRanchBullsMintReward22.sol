...
//     /**
//      * @dev These contracts will have the ability to call the updateUSDCBonusAmtForAddress
//      * function. As this is the primary reward token for minting and paying Maint Fees, We plan to launch another NFT contract that will award 
...
//      * to be an additional source of revenue for each BTC Bull Owner 
//     */
//     bytes32 public constant INTERACT_ROLE = keccak256("INTERACT_ROLE");
//     bytes32 public constant DEFENDER_ROLE = keccak256("DEFENDER_ROLE");
//     bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");

//     modifier ADMIN_OR_DEFENDER {
//         require(hasRole(ADMIN_ROLE, msg.sender)|| hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || hasRole(DEFENDER_ROLE, msg.sender), "Caller is not an ADMIN OR DEFENDER");
//         _;
//     }

//     modifier ADMIN_ONLY {
//         require(hasRole(ADMIN_ROLE, msg.sender) || hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not an ADMIN");
//         _;
//     }
...
//     event FundedRewardsForTheBulls(
...
//             uint256 indexed totalAmountDispersed,
...
//     uint256 public monthlyAmountToDisperse;

//     function fundBulls(uint256 _totalAmountToDeposit) public payable ADMIN_OR_DEFENDER{
...
//         monthlyAmountToDisperse += _totalAmountToDeposit;
//         emit FundedRewardsForTheBulls(_totalAmountToDeposit, msg.sender);

//     }


//     function fundAndRewardBulls() public payable ADMIN_OR_DEFENDER {
//         if (calculatedMonthlyMaintenanceFee == 0) { revert Rewarding_NotReady();}
//         if (monthlyAmountToDisperse == 0) { revert Rewarding_NotReady();}
...
//         emit fundAndRewardEvent(monthlyAmountToDisperse, 1, _tokenSupply.current());

//         // reset monthly amount
//         monthlyAmountToDisperse = 0;
//     }



//     // function fundAndRewardBulls(uint _startingIndex, uint _endingIndex, uint256 _totalAmountToDeposit) public payable ADMIN_OR_DEFENDER {
...
//         require(hasRole(INTERACT_ROLE, msg.sender), "must be approved to interact");
...
//         emit MaintenanceFeeEvent('_STEP2DONE_ Updated Monthly Fees For Current BTC Bull Owners');
...
//         // emit event
//         emit MaintenanceFeeEvent('Finsihed Liquidated Outstanding Accounts');
//     }
...
//     function setBaseURI(string memory _newBaseURI) external ADMIN_ONLY{
//         baseURI = _newBaseURI;
//     }


//     function setBaseExtension(string memory _newBaseExtension) external ADMIN_ONLY {
//         baseExtension = _newBaseExtension;
//     }

//     function togglePublicSaleStatus() external ADMIN_ONLY{
//         publicSaleLive = !publicSaleLive;
//     }

//     function togglePauseStatus() external ADMIN_ONLY{
...
//         uint _percent_2
//         ) external ADMIN_ONLY {
//         require(address(_owner) != address(0) && address(_coreTeam_1) != address(0) && address(_coreTeam_2) != address(0) , "ERROR: The address can't be address(0)");
...
//     function set_minting_price(uint _price) external ADMIN_ONLY {
//         require(paused, "ERROR: CANT CHANGE PRICE IF CONTRACT IS NOT PAUSED");
//         mintingCost = _price;
//     }

//     function setUsdcTokenAddress(address _address) public ADMIN_ONLY {
//         require(address(_address ) != address(0), "ERROR: The Minting address can't be address(0)");
//         usdcTokenContract = _address;
//     }

//     function setUsdcTokenDecimals(uint _decimals) public  ADMIN_ONLY {
//         usdcTokenDecimals = _decimals;
//     }

//     function setWbtcTokenAddress(address _address) public ADMIN_ONLY {
//         require(address(_address ) != address(0), "ERROR: The Minting address can't be address(0)");
//         wbtcTokenContract = _address;
//     }

//     function setWbtcTokenDecimals(uint _decimals) public ADMIN_ONLY {
//         wbtcTokenDecimals = _decimals;
//     }

//     function setSubscriptionId(uint64 _subscriptionId) public ADMIN_ONLY {
//         subscriptionId = _subscriptionId;
//     }

//     function setGasLane(bytes32 _gasLane) public ADMIN_ONLY {
//         gasLane = _gasLane;
//     }

//     function setCallbackGasLimit(uint32 _callbackGasLimit) public ADMIN_ONLY {

//         callbackGasLimit = _callbackGasLimit;
//     }

//     function setVrfCoordinator(VRFCoordinatorV2Interface _vrfCoordinator) public ADMIN_ONLY {
//         vrfCoordinator = _vrfCoordinator;
//     }

//     function blacklistMalicious(address account, bool value) external ADMIN_ONLY {
//         isBlacklisted[account] = value;
//     }

//     function setMonthlyMaintenanceFeePerNFT(uint256 _monthly_maint_fee_per_nft) external ADMIN_ONLY {
