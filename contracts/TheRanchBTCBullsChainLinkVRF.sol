...
contract TheRanchBTCBullsChainLinkVRF is VRFConsumerBaseV2, Ownable {
    ...
    function getRaffleWinner() public onlyOwner {
    ...
    function fake_fulfillRandomWords() public ADMIN_OR_DEFENDER {

        // require(isDefenderRole[msg.sender] == true, "must be approved to interact");
