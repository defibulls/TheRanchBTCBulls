...
def test_TRBCProxy_blacklist_usdc():
    ...
    proxy_TRBC.setPartnerAddress(person_5,{"from": person_6})
    assert proxy_TRBC.myPartner(person_6) == person_5
    ...
    with pytest.raises(exceptions.VirtualMachineError):
        rewards_withdraw_event = proxy_TRBC.withdrawUsdcBalance({"from": person_5})
