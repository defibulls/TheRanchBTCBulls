...
def test_TRBCProxy_gas_reward_30_1mintEach_with_transfers():
    ...
    proxy_TRBC.transferFrom(person_1, person_5, 1, {"from": person_1}) 
    proxy_TRBC.transferFrom(person_2, person_5, 2, {"from": person_2}) 
    proxy_TRBC.transferFrom(person_3, person_5, 3, {"from": person_3})
    proxy_TRBC.transferFrom(person_4, person_5, 4, {"from": person_4})
    proxy_TRBC.transferFrom(person_5, person_5, 5, {"from": person_5})
    proxy_TRBC.transferFrom(person_6, person_5, 6, {"from": person_6})
    proxy_TRBC.transferFrom(person_7, person_5, 7, {"from": person_7})
    proxy_TRBC.transferFrom(person_8, person_5, 8, {"from": person_8})
    proxy_TRBC.transferFrom(person_9, person_5, 9, {"from": person_9})
    proxy_TRBC.transferFrom(person_10, person_5, 10, {"from": person_10})
    ...
    print("#######################################################################################")
    print(f'coreTeam_1 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":coreTeam1})  }')
    print(f'coreTeam_2 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":coreTeam2})  }')
    print(f'person_1 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_1})  }')
    print(f'person_2 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_2})  }')
    print(f'person_3 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_3})  }')
    print(f'person_4 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_4})  }')
    print(f'person_5 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_5})  }')
    print(f'person_6 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_6})  }')
    print(f'person_7 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_7})  }')
    print(f'person_8 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_8})  }')
    print(f'person_9 total maintenance fees due: {proxy_TRBC.getWbtcBalanceForAddress({"from":person_9})  }')
    ...
    expected_bonus_for_owners_not_having_a_partner = (proxy_TRBC.payPerNftForTheMonth.call() * 0.01) * 30
    ...
    assert proxy_TRBC.getWbtcBalanceForAddress({"from":person_5}) == (((total_to_deposit * 0.90) * .98) / 30) * 10
    assert proxy_TRBC.getWbtcBalanceForAddress({"from":person_6}) == 0
    assert proxy_TRBC.getWbtcBalanceForAddress({"from":person_7}) == 0
    ...
    assert proxy_TRBC.getMaintenanceFeeBalanceForAddress({"from":person_5}) == 12000000 * 10
