...
def test_roles():
    ...
    mocked_wbtc = MockedTokens_WBTC.deploy(5 * 10**8, {"from": multisig})
    ...
    with pytest.raises(exceptions.VirtualMachineError):
        TheRanchBullsMintAndReward.setMintingPrice(1800, {"from": multisig})
    ...
    set_mint_price = TheRanchBullsMintAndReward.setMintingPrice(1800, {"from": multisig})
